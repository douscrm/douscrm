...
class ContactProfile extends Component {
	...
	componentDidMount() {
		...
		axios.get(`${globals.api}/contacts/${id}`).then((response) => {
	...
	deleteItem() {
		...
		axios.delete(`${globals.api}/contacts/${id}`).then((response) => {
			...
			<div className="row">
				<div className="col-12">
					<BoxCard>
						...
						<BoxCardFooter>
							<Link className="btn btn-primary float-left" to={`/contacts/${this.model.id}/update`}>Edit contact</Link>
