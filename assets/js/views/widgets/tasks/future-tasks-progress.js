...
class FutureTasksProgress extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<Card loading={!this.state.loadTask} title={this.props.title || 'Future tasks'} style={{textAlign: 'center'}}>
...
export default FutureTasksProgress;